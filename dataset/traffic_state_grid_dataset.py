...
class TrafficStateGridDataset(TrafficStateDataset):
    def __init__(self, config):
        ...
        self.cache_fparameters_strile_name = os.path.join('./cache/dataset_cache/',
    ...
    def _load_rel(self):
        ...
        """
        if os.path.exists(os.path.join(self.cache_file_folder, "{}_adj.npz".format(self.dataset))):
            super()._load_cache_adj()
        else:
            ...
            if self.cache_dataset:
                ...
                np.savez_compressed(
                    os.path.join(self.cache_file_folder, "{}_adj.npz".format(self.dataset)),
                    adj_mx=self.adj_mx,
